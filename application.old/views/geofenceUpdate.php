    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title"><?= lang('updateGeofence') ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right col-md-6 col-12 d-none d-md-block">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item pl-0 active"><?= lang('updateGeofence') ?></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <section id="geofenceCard" class="card">
                <div class="card-content collapse show">
                    <div class="card-header">
                        <h4 class="card-title" id="updateUserCardTitle"><?=lang('updateGeofence')?></h4>
...
<script>
    $(document).ready(function () {
        ...
        if (speedUnit === 'kmh') {
            let speedLimit = $.number_format(parseFloat(geofence.attributes.speedLimit) * 1.852, '0', '', '');
        ...
        if (distanceUnit === 'km') {
            let polylineDistance = $.number_format(parseFloat(geofence.attributes.polylineDistance) / 1000, '0', '', '');
        ...
        saveUpdateGeofenceButton.on('click', function (e) {
            ...
            userValidation.validate().then(function (status) {
                if (status === 'Valid') {
                    $.ajax({
                        url: '<?=base_url('rest/setting/update-geofence')?>',
                        method: "POST",
                        data: updateGeofenceForm.serializeToJSON({}),
                        beforeSend: function () {
                            geofenceCard.block({
