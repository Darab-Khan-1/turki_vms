    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title"><?= lang('addUser') ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right col-md-6 col-12 d-none d-md-block">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item pl-0"><a href="<?= base_url('panel/users') ?>"><?= lang('users') ?></a></li>
                        <li class="breadcrumb-item pl-0 active"><?= lang('addUser') ?></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <section id="userCard" class="card">
                <div class="card-content collapse show">
                    <div class="card-header">
                        <h4 class="card-title" id="addUserCardTitle"><?=lang('addUser')?></h4>
                        <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <button type="button" class="btn btn-icon btn-light cancel" id="cancelAddButton">
                                <?=lang('back')?>
                            </button>
                        </div>
                    </div>
                    <div class="card-body py-0">
                        <form class="form addUserForm" id="addUserForm" name="addUserForm" novalidate="">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        <ul class="nav nav-tabs nav-top-border no-hover-bg" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="required-tab" data-toggle="tab" href="#required" aria-controls="required" role="tab" aria-selected="true"><?=lang('required')?></a>
                                            </li>
                                        </ul>
                                        <div class="tab-content pt-1">
                                            <div class="tab-pane active" id="required" aria-labelledby="required-tab" role="tabpanel">
                                                <div class="form-group">
                                                    <label class="" for="name"><?=lang('name')?></label>
                                                    <input type="text" id="name" class="form-control" placeholder="<?=lang('name')?>" name="name">
                                                </div>
                                                <div class="form-group">
                                                    <label class="" for="email"><?=lang('email')?></label>
                                                    <input type="text" id="email" class="form-control" placeholder="<?=lang('email')?>" name="email">
                                                </div>
                                                <div class="form-group">
                                                    <label class="" for="password"><?=lang('password')?></label>
                                    ...
                                    <div class="col-md-10">
                                        <ul class="nav nav-tabs nav-top-border no-hover-bg flex-nowrap">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-preferenceTab" data-toggle="tab" aria-controls="preferenceTab" href="#preferenceTab" aria-expanded="true"><?=lang('preference')?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="base-authorityTab" data-toggle="tab" aria-controls="authorityTab" href="#authorityTab" aria-expanded="false" ><?=lang('authority')?></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="base-attributesTab" data-toggle="tab" aria-controls="attributesTab" href="#attributesTab" aria-expanded="false"><?=lang('attributes')?></a>
                                            </li>
                                        </ul>
                                        <div class="tab-content pt-1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="phone" class="form-control" placeholder="<?=lang('phone')?>" name="phone">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6" id="mapColSelect">
                                                                <div class="form-group">
                                                                    <label for="map">Map</label>
                                                                    <select id="map" name="map" class="select2 form-control" data-placeholder="<?=lang('map')?>"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="latitude" class="form-control" placeholder="<?=lang('latitude')?>" name="latitude">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="longitude"><?=lang('longitude')?></label>
                                                                    <input type="text" id="longitude" class="form-control" placeholder="<?=lang('longitude')?>" name="longitude">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="zoom"><?=lang('zoom')?></label>
                                                                    <input type="text" id="zoom" class="form-control" placeholder="<?=lang('zoom')?>" name="zoom">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="custom-control custom-checkbox">
                                                                        ...
                                                                        <label class="custom-control-label" for="twelveHourFormat"><?=lang('twelveHourFormat')?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="expirationTime"><?=lang('expirationTime')?></label>
                                                                    <input type="text" id="expirationTime" name="expirationTime" class="form-control"
                                                                           readonly="readonly" placeholder="<?=lang('expirationTime')?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="deviceLimit"><?=lang('deviceLimit')?></label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="userLimit"><?=lang('userLimit')?></label>
                                                                    <input type="number" id="userLimit" class="form-control" placeholder="<?=lang('userLimit')?>" name="userLimit">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" id="token" name="token" class="form-control" placeholder="<?=lang('token')?>">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                                ...
                                                                <label class="custom-control-label" for="disabled" ><?=lang('disabled')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                                <input type="checkbox" class="custom-control-input" name="administrator" id="administrator" value="0">
                                                                <label class="custom-control-label" for="administrator"><?=lang('administrator')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                                <input type="checkbox" class="custom-control-input" name="readonly" id="readonly" value="0">
                                                                <label class="custom-control-label" for="readonly" ><?=lang('readOnly')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                                <input type="checkbox" class="custom-control-input" name="deviceReadonly" id="deviceReadonly" value="0">
                                                                <label class="custom-control-label" for="deviceReadonly" ><?=lang('deviceReadOnly')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="d-inline-block custom-control custom-checkbox mr-1">
                                                                <input type="checkbox" class="custom-control-input" name="limitCommands" id="limitCommands" value="0">
                                                                <label class="custom-control-label" for="limitCommands" ><?=lang('limitCommands')?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="attributesTab" aria-labelledby="base-attributesTab">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h6 class="i18n border-bottom pb-0-5"><?=lang('mail')?></h6>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="mailSmtpHost"><?=lang('SMTPHost')?></label>
                                                                    <input type="text" id="mailSmtpHost" class="form-control" placeholder="<?=lang('SMTPHost')?>" name="attributes.mailSmtpHost">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="mailSmtpPort"><?=lang('SMTPPort')?></label>
                                                                    <input type="text" id="mailSmtpPort" class="form-control" placeholder="<?=lang('SMTPPort')?>" name="attributes.mailSmtpPort">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="mailSmtpFrom"><?=lang('SMTPFrom')?></label>
                                                                    <input type="text" id="mailSmtpFrom" class="form-control" placeholder="<?=lang('SMTPFrom')?>" name="attributes.mailSmtpFrom">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="mailSmtpUsername"><?=lang('SMTPUsername')?></label>
                                                                    <input type="text" id="mailSmtpUsername" class="form-control" placeholder="<?=lang('SMTPUsername')?>" name="attributes.mailSmtpUsername">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="mailSmtpPassword"><?=lang('SMTPPassword')?></label>
                                                                    <input type="text" id="mailSmtpPassword" class="form-control" placeholder="<?=lang('SMTPPassword')?>" name="attributes.mailSmtpPassword">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="mailSmtpAuth"><?=lang('SMTPAuthEnable')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                <input type="checkbox" class="custom-control-input" id="mailSmtpStarttlsEnable" name="attributes.mailSmtpStarttlsEnable" value="0">
                                                                <label class="custom-control-label" for="mailSmtpStarttlsEnable"><?=lang('SMTPSTARTTLSActive')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="mailSmtpStarttlsRequired"><?=lang('SMTPSTARTTLSRequired')?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="mailSmtpSslEnable"><?=lang('SMTPSSLActive')?></label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                                ...
                                                                <label class="custom-control-label" for="mailSmtpSslProtocols"><?=lang('SMTPSSLTrusted')?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="i18n border-bottom pb-0-5"><?=lang('web')?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="webLiveRouteLength"><?=lang('LiveRouteLength')?></label>
                                                                    <input type="text" id="webLiveRouteLength" class="form-control" placeholder="<?=lang('LiveRouteLength')?>" name="attributes.webLiveRouteLength">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="webSelectZoom"><?=lang('ZoomOnSelect')?></label>
                                                                    <input type="text" id="webSelectZoom" class="form-control" placeholder="<?=lang('ZoomOnSelect')?>" name="attributes.webSelectZoom">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="webMaxZoom"><?=lang('MaximumZoom')?></label>
                                                                    <input type="text" id="webMaxZoom" class="form-control" placeholder="<?=lang('MaximumZoom')?>" name="attributes.webMaxZoom">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="i18n border-bottom pb-0-5"><?=lang('general')?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6" id="distanceUnitColSelect">
                                                                <div class="form-group">
                                                                    <label for="distanceUnit"><?=lang('distanceUnit')?></label>
                                                            ...
                                                            <div class="col-md-6" id="speedUnitColSelect">
                                                                <div class="form-group">
                                                                    <label for="speedUnit"><?=lang('speedUnit')?></label>
                                                            ...
                                                            <div class="col-md-6" id="volumeUnitColSelect">
                                                                <div class="form-group">
                                                                    <label for="volumeUnit" ><?=lang('volumeUnit')?></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h6 class="i18n border-bottom pb-0-5" ><?=lang('ui')?></h6>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        ...
                                                                        <label class="custom-control-label" for="uiDisableReport"><?=lang('DisableReport')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        <input type="checkbox" class="custom-control-input" id="uiDisableEvents" name="attributes.uiDisableEvents" value="0">
                                                                        <label class="custom-control-label" for="uiDisableEvents" ><?=lang('DisableEvents')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        ...
                                                                        <label class="custom-control-label" for="uiDisableVehicleFeatures" ><?=lang('DisableVehicleFeatures')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        <input type="checkbox" class="custom-control-input" id="uiDisableDrivers" name="attributes.uiDisableDrivers" value="0">
                                                                        <label class="custom-control-label" for="uiDisableDrivers"><?=lang('DisableDrivers')?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        ...
                                                                        <label class="custom-control-label" for="uiDisableComputedAttributes"><?=lang('DisableComputedAttributes')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        <input type="checkbox" class="custom-control-input" id="uiDisableCalendars" name="attributes.uiDisableCalendars" value="0">
                                                                        <label class="custom-control-label" for="uiDisableCalendars"><?=lang('DisableCalendars')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        <input type="checkbox" class="custom-control-input" id="uiDisableMaintenance" name="attributes.uiDisableMaintenance" value="0">
                                                                        <label class="custom-control-label" for="uiDisableMaintenance"><?=lang('DisableMaintenance')?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="custom-control custom-checkbox custom-control-inline">
                                                                        ...
                                                                        <label class="custom-control-label" for="uiHidePositionAttributes"><?=lang('HidePositionAttributes')?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        marker.bindPopup("<b>Hi!</b><br><?=lang('dragMe')?>").openPopup();
        let ll = marker.getLatLng();
        //console.log(ll);
        $('#addUserForm #latitude').val(ll.lat);
        $('#addUserForm #longitude').val(ll.lng);
        $('#addUserForm #zoom').val(mymap.getZoom());
        ...
        var userValidation = FormValidation.formValidation(addUserForm[0], {
            fields: {
                name: {
                    validators: {
                        notEmpty: {
        ...
        addUserForm.on('keypress', function (e) {
            if (e.which === 13) {
        ...
        saveAddUserButton.on('click', function (e) {
            ...
            userValidation.validate().then(function (status) {
                if (status === 'Valid') {
                    $.ajax({
                        url: '<?=base_url('rest/setting/create-user')?>',
                        method: "POST",
                        data: addUserForm.serializeToJSON({}),
                        beforeSend: function () {
                            userCard.block({
