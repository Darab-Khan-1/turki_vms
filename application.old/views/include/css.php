<title>NET Arac Takip Sistemleri</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
<meta name="title" content="NET Arac Takip Sistemleri">
<meta name="description" content="Traccar GPS Tracking System">
<meta name="author" content="Lintasevolusi">
<meta name="viewport" content="width=device-width,initial-scale=1.0,user-scalable=0,minimal-ui">
<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="https://takip.netaractakip.com/">
<meta property="og:title" content="NET Arac Takip Sistemleri">
<meta property="og:description" content="Traccar GPS Tracking System">
<!--<meta property="og:image" content="https://metatags.ioassets/meta-tags-16a33a6a8531e519cc0936fbba0ad904e52d35f34a46c97a2c9f6f7dd7d336f2.png">-->

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://takip.netaractakip.com/">
<meta property="twitter:title" content="NET Arac Takip Sistemleri">
<meta property="twitter:description" content="Traccar GPS Tracking System">
<!--<meta property="twitter:image" content="https://metatags.ioassets/meta-tags-16a33a6a8531e519cc0936fbba0ad904e52d35f34a46c97a2c9f6f7dd7d336f2.png">-->

<!-- Fav Icon  -->
<link rel="shortcut icon" href="<?=base_url()?>app-assets/images/logo/favicon.ico" type="image/x-icon"/>
<link rel="apple-touch-icon" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon.png"/>
<link rel="apple-touch-icon" sizes="57x57" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-57x57.png"/>
<link rel="apple-touch-icon" sizes="72x72" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-72x72.png"/>
<link rel="apple-touch-icon" sizes="76x76" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-76x76.png"/>
<link rel="apple-touch-icon" sizes="114x114" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-114x114.png"/>
<link rel="apple-touch-icon" sizes="120x120" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-120x120.png"/>
<link rel="apple-touch-icon" sizes="144x144" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-144x144.png"/>
<link rel="apple-touch-icon" sizes="152x152" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-152x152.png"/>
<link rel="apple-touch-icon" sizes="180x180" href="<?=base_url()?>app-assets/images/logo/apple-touch-icon-180x180.png"/>
