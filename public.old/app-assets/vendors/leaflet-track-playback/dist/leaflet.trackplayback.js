!function (t, i) {
  ...
  return function (t) {
    ...
    const a = n.a.Class.extend({
      ...
      includes: n.a.Mixin.Events, options: {speed: 12, maxSpeed: 65}, initialize: function (t, i) {
      ...
      trackLineOptions: {isDraw: !1, stroke: !0, color: "#1C54E2", weight: 2, fill: !1, fillColor: "#000", opacity: .3},
      targetOptions: {
        useImg: !1,
