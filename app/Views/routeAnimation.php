    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title"><?=lang('Text.route_history')?> (<?=lang('Text.animation')?>)</h3>
            </div>
            <div class="content-header-right breadcrumbs-right col-md-6 col-12 d-none d-md-block">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item pl-0 active"><?=lang('Text.animation')?></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="content-body">
            ...
            <section id="mapCard" class="card d-none">
                <div class="card-header">
                    <h4 class="card-title"><?=lang('Text.route_history')?> (<?=lang('Text.animation')?>)</h4>
                </div>
                <div class="card-content collapse show">
