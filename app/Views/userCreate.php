    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12">
                <h3 class="content-header-title"><?= lang('Text.addUser') ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right col-md-6 col-12 d-none d-md-block">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item pl-0 active"><?= lang('Text.addUser') ?></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <section id="userCard" class="card">
                <div class="card-content collapse show">
                    <div class="card-header">
                        <h4 class="card-title" id="addUserCardTitle"><?=lang('Text.addUser')?></h4>
        ...
        var userValidation = FormValidation.formValidation(addUserForm[0], {
            fields: {
                ...
                password: {
                    validators: {
                        notEmpty: {
                            message: '<?=lang('Text.passwordRequired')?>'
                        }
                    }
                }
            },
        ...
        saveAddUserButton.on('click', function (e) {
            ...
            userValidation.validate().then(function (status) {
                if (status === 'Valid') {
                    ...
                    $.axiosPost("<?=base_url('rest/setting/create-user')?>", headers, addUserForm.serializeToJSON({}), userCard, callback);
                }
            });
        });
    });
